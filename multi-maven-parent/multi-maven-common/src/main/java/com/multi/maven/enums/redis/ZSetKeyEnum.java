 ...
 * @since v1.0
 */
public enum ZSetKeyEnum implements CacheKeyEnum<String> {

    /**课程选择列表，存储课程ID*/
//	ZSET_COURSE_INFO_COURSEID("zset_course_info_courseid","BIZ_COURSE_INFO,课程选择列表"),
    ;
    ...
    private ZSetKeyEnum(String value, String displayName) {
        this.value = value;
        this.displayName = displayName;
    }
